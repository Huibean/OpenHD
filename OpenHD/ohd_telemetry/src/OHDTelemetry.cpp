...
OHDTelemetry::OHDTelemetry(OHDProfile profile1, const openhd::Config& config, bool enableExtendedLogging)
  ...
  if (this->m_profile.is_air) {
    ...
    m_ground_telemetry = std::make_unique<GroundTelemetry>(config.NW_FORWARDING_TELEMETRY_PORT);
